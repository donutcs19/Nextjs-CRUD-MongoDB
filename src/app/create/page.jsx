...
return (
    <div className='container mx-auto py-10'>
        <h3 className='text-3xl font-bold'>Create Content</h3>
        <hr className='my-3'/>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <button type='submit' className='bg-green-500 text-white border py-2 px-3 text-lg my-2'>Create Content</button>
        </form>
